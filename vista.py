...
------------------------""")
            ...
            elif menuProduccion == "5":
                 print(Fore.RESET+"""
                    1) LISTAR toda la producción de un día específico  
                    2) LISTAR toda la producción en un rango de fechas específico   
                    3) LISTAR todos los insumos para la producción de un día específico """) 
